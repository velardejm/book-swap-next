...
export async function sendSwapRequest(requestedBook, offerredBook) {
  const { id: requestedBookId, owner_id: requestedBookOwnerId } =
    requestedBook;
  const { id: offerredBookId, owner_id: offerredBookOwnerId } = offerredBook;
  const requestData = { requestedBookId, requestedBookOwnerId, offerredBookId, offerredBookOwnerId }
